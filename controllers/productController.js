...
export const RelatedProductController = async (req, res) => {
  try {
    ...
    const products = await productModel
      .find({
        catagory: cid,
        _id: { $ne: pid }, // mean which product is selected should not show in similar
      })
      .select("-photo")
      .limit(3)
      .populate("catagory");
...
export const ProductCatagorySlug = async (req, res) => {
  try {
...
// payment gateway
// get token
export const BrainteeTokenController = async (req, res) => {
  try {
